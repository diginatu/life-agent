...
7. **LayerUpdate** — rolls up L1 logs into hourly L2 summaries, L2 into 6-hour L3 summaries, and distills evicted L3 entries into a single persistent L4 memory text (delayed, idempotent, catches up after sleep)
